...
export function DashboardWorkspacePanel({
  ...
  return (
    <section className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden xl:contents">
      ...
      <div className="flex min-h-0 flex-1 flex-col gap-4 overflow-hidden sm:gap-6 xl:col-start-2 xl:row-start-2">
